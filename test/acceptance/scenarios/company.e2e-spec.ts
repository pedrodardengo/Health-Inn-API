...
describe('Companies Behavior', () => {
    ...
    describe('behaviour of work relation', () => {
        ...
        it(
            'should add a work relation for a specific company and employee and retrieve it later',
            async () => {
                // Arrange
                ...
                // Assert
                companyDSL.assertWorkRelationMatch(workRelation,
                    workRelationData)
            })
                ...
                const workRelationData2 = await companyDSL.givenWorkRelation(
                    {
                        isActive: true,
                        registered: false,
                        forEmployee: workRelationData1.employeeCPF,
                    },
                )
