...
describe('CompanyService', () => {
    ...
    describe('registerCompany', () => {
        ...
        it('should return company after creating it', async () => {
            ...
            // Act
            const result = await companyService.registerCompany(new CompanyDTO());

            // Assert
            expect(result).toBeDefined();
        });

        it('should throw ConflictException if repository returns null meaning conflict', async () => {
            // Arrange
            ...
            // Act
            const request = companyService.registerCompany(new CompanyDTO());
